...
we go. (STAB27/STAC67 ideas.) xxx to here
...
```{r logvisplot, fig.keep="none", warning=F}
...
## Comments
- R-squared 81%, not so bad. xxx
- F -statistic and P-value assert that something helping to predict
rut.depth.
...
transformation of y.
- The residuals-vs-x’s plots don’t know any serious trends. Worst
