...
- If you specify a value for d, it will be used. If you don't, 1 will be used instead: xxx
...
The mean of each column, with the columns labelled. xxx
...
out of the `while` and return the whole `ans`. xxx
