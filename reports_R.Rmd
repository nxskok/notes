...
and gives highlights of results and conclusion:
...
## Conclusions (selected) 1/2 xxx chat at bottom
...
## Writing your own report (xxx write)  
...
- A complete report of an analysis has (at least) three parts:
  ...
  - Analysis, where you describe the steps you took to get the data into shape for your analysis, and what analysis you did *and why*.
