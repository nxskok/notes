## Communicating your results qqq

- Being a statistician means being able to do several things: qqq
...
what the results mean, to you and the world. qqq
...
and re-knit.
- PDF, via a LaTeX installation qqq such as `tinytex` qqq (R Studio Cloud has this).
